...
export function RoutineCard({ 
    ...
    <>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "14px", minWidth: 0, overflow: "hidden" }}>
        ...
        <div style={{ 
          ...
          height: "36px", 
          borderRadius: "10px", 
          background: "var(--ht-bg-card-subtle, rgba(255, 255, 255, 0.05))", 
          border: "1px solid var(--ht-border-card, rgba(255, 255, 255, 0.08))",
          display: "flex", 
          alignItems: "center", 
          justifyContent: "center", 
          fontSize: "18px", 
        ...
        <div style={{ flex: 1, minWidth: 0, overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <span style={{ 
              ...
              fontWeight: 800, 
              fontSize: "15px", 
              color: allDone ? "#10b981" : "var(--ht-text-primary, #f9fafb)", 
          ...
          {totalCount > 0 && (
            <div style={{ display: "flex", alignItems: "center", gap: "6px", marginTop: "4px" }}>
              <div style={{ flex: 1, height: "3px", borderRadius: "999px", background: "var(--ht-border-card, rgba(255, 255, 255, 0.05))", overflow: "hidden", minWidth: 0 }}>
                <div style={{ 
                  height: "100%", 
              ...
              <span style={{ fontSize: "10px", color: "var(--ht-text-muted, #6b7280)", fontWeight: 700, flexShrink: 0 }}>{doneCount}/{totalCount}</span>
            </div>
          )}
        </div>
  ...
  return (
    <div
      ...
      style={{
        border: `1px solid ${allDone ? "rgba(16, 185, 129, 0.2)" : "var(--ht-border-card)"}`,
        borderRadius: "20px",
        padding: "16px",
        background: allDone 
          ? "var(--ht-bg-routine-done)" 
          : "var(--ht-bg-routine)",

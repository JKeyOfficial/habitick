...
export function ProfileModal({ initialTab = "account", session, profile, habits = [], todos = [], goals = [], journalEntries = {}, showTodayOnly, onChangeShowTodayOnly, hideEmptyRoutines, onChangeHideEmptyRoutines, onUpdate, onClose, onUpgrade }) {
    ...
    <DragSheet onClose={onClose}>
      ...
      {tab === "account" && (
        <div style={{ animation: "fadeUp 0.2s ease-out" }}>
          ...
          <div style={{ fontSize: "11px", color: "#6b7280", lineHeight: 1.4, marginBottom: "16px" }}>
            Choose whether to display all habits on the dashboard, or filter to show only habits scheduled for today.
          </div>

          {/* Routine Display Preference */}
          <span style={sectionLbl}>Routine List View</span>
          <div style={{ display: "flex", gap: "8px", marginBottom: "12px" }}>
            <button
              ...
              style={{
                ...
                background: !hideEmptyRoutines ? "rgba(59, 130, 246, 0.08)" : "transparent",
          ...
          <div style={{ fontSize: "11px", color: "#6b7280", lineHeight: 1.4, marginBottom: "12px" }}>
            Choose whether to display all routines, or hide empty routines that currently have no habits assigned.
          </div>
